...
namespace Utils
{
    public static class Vector3Extensions
    {
        ...
        public static Vector3 WithX(this Vector3 self, Func<float, float> xChangeFunc) =>
            new Vector3(xChangeFunc(self.x), self.y, self.z);

        public static Vector3 WithY(this Vector3 self, Func<float, float> yChangeFunc) =>
            new Vector3(self.x, yChangeFunc(self.y), self.z);

        public static Vector3 WithZ(this Vector3 self, Func<float, float> zChangeFunc) =>
            new Vector3(self.x, self.y, zChangeFunc(self.z));
