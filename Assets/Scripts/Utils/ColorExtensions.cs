...
namespace Assets.Scripts.SharedUtils.Extensions
{
    public static class ColorExtensions
    {
        ...
        public static Color WithR(this Color self, Func<float, float> rChangeFunc) => new Color(rChangeFunc(self.r), self.g, self.b);
        public static Color WithG(this Color self, Func<float, float> gChangeFunc) => new Color(self.r, gChangeFunc(self.g), self.b);
        public static Color WithB(this Color self, Func<float, float> bChangeFunc) => new Color(self.r, self.g, bChangeFunc(self.b));
